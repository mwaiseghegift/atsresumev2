...
/* ════════════════════════════════════════════
   Main component
   ════════════════════════════════════════════ */
export default function AIPanel({ resumeData, onCustomized, forceView, setForceView }) {
    ...
    <aside className="ai-panel exclude-print">
      ...
      <div className="ai-panel-body p-4 flex flex-col gap-3">
        ...
        <div className="flex gap-2 pt-1">
          ...
          <button onClick={() => setView('idle')} className="btn-outline flex-1 justify-center">
            Cancel
          </button>
        </div>
      </div>
  ...
  if (view === 'results' && result) {
    ...
    return (
      <aside className="ai-panel exclude-print">
        <div className="ai-panel-header">
          <h2 className="ai-panel-title"><SparkleIcon /> AI Assistant</h2>
          <button onClick={() => { setView('idle'); setResult(null); }}
